...
<div class="product-grid">
    ...
    <div class="product-card">
        <img src="assets/random/15.png" alt="Product 1">
        <h3>Adidas</h3>
    ...
    <div class="product-card">
        <img src="assets/random/16.png" alt="Product 2">
    ...
    <div class="product-card">
        <img src="assets/random/7.png" alt="Product 3">
        <h3>Heels</h3>
        <p class="all-desc">Gloria Covered Heels</p>
        <p class="price">LKR 8950.00</p>
        <button class="add-to-cart" data-name="Product 3" data-price="1000">Add to Cart</button>
    </div>

    <div class="product-card">
        <img src="assets/random/9.png" alt="Product 4">
        <h3>Heels</h3>
        <p class="all-desc">TAmara Covered Slingback Heels</p>
        <p class="price">LKR
            8700.00</p>
    ...
    <div class="product-card">
        <img src="assets/random/10.png" alt="Product 4">
        <h3>Heels</h3>
        <p class="all-desc">TAmara Covered Slingback Heels</p>
        <p class="price">LKR 8700.00</p>
        <button class="add-to-cart" data-name="Product 4" data-price="1000">Add to Cart</button>
    </div>

    <div class="product-card">
        <img src="assets/random/12.png" alt="Product 5">
        <h3>Bata</h3>
    ...
    <div class="product-card">
        <img src="assets/random/13.png" alt="Product 6">
    ...
    <div class="product-card">
        <img src="assets/random/14.png" alt="Product 7">
    ...
    <div class="product-card">
        <img src="assets/random/19.png" alt="Product 8">
        <h3>Adidas</h3>
        <p class="all-desc">Adidas Originals Superstar Shoes</p>
        <p class="price">LKR 15000.00</p>
